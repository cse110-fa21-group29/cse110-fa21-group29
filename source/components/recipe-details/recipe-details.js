class RecipeDetails extends HTMLElement {
  ...
  async connectedCallback() {
    let elementContent = await fetch('components/recipe-details/recipe-details.html');
  ...
  bindButton() {
    ...
    buttonElement.addEventListener('click', () => {
      const routerEvent = new CustomEvent('router-navigate', { detail: 'home-page', bubbles: true, composed: true });
